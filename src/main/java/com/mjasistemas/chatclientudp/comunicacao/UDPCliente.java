    ...
    private void tratarResposta(String resp) {
        ...
        switch (sResp) {
            ...
            case "02": //resposta solicitação entrar na sala
                ...
                break;
            case "03": //resposta solicitação listaLogados
                ret = resp.substring(2, 3);
                strRetorno = resp;
                switch (ret) {
                    case "0":
            ...
            case "04": //resposta solicitação de mensagem
                ...
                break;
            case "05": //resposta solicitação de mensagem
                ret = resp.substring(2, 3);
                strRetorno = resp;
                switch (ret) {
                    case "0":
                        ...
                        break;
                    case "1":
                        retornoSolicitacao = RetornoEnum.MENSAGEM_SEM_PERMISSAO;
                        break;
                    case "2":
                        retornoSolicitacao = RetornoEnum.MENSAGEM_SEM_SALA;
                        break;
                }
                break;
            case "0":
